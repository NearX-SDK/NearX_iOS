...
class ViewController: UIViewController, UITextFieldDelegate , UITextViewDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
        print("Form Ready!")
        if(UserDefaults.standard.object(forKey: Keys.PreferencesKeys.AUTH_KEY) != nil)
        {
            userKey.text = UserDefaults.standard.string(forKey: Keys.PreferencesKeys.AUTH_KEY)!
        }
        if(UserDefaults.standard.object(forKey: Keys.PreferencesKeys.NAME) != nil)
        {
            userName.text = UserDefaults.standard.string(forKey: Keys.PreferencesKeys.NAME)!
        }
        if(UserDefaults.standard.object(forKey: Keys.PreferencesKeys.MOBILE_NUMBER) != nil)
        {
            userMobile.text = UserDefaults.standard.string(forKey: Keys.PreferencesKeys.MOBILE_NUMBER)!
        }
    }
